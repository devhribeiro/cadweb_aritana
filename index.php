    ...
    <div class="container">
        ...
        <form>
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="0.000.000 ES">
            </div>

            <div class="form-group">
                <label for="exampleFormControlInput1">Data de Nascimento</label>
                <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="00/00/000">
            </div>
